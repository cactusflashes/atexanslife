...
<div class="container">
    <div class="body-container">
            ...
            <p>
                Shortly prior to his graduation, Juan and Virginia, who had been dating for a few years prior, 
                made the decision to get engaged. Juan sold his Fender Stratocaster guitar to pay for their engagement ring.
            </p>
            <div style="height: 15px"></div>
            <h5>
                "Nowadays, I look at a picture of my guitar, then look at Ginny [and back] at the guitar. Then I thank God. My wife,
                children, and grandchildren that we have because of that guitar are priceless, and I'm so blessed."
            </h5>
            ...
            <img src={jpdeck} alt="Juan and Ginny on the deck of the Kearsarge." class="page-img"/>
             ...
             <p>
                ...
                the possibility of an attack from enemy weapons. Juan's final position in the Navy was as a Yeoman 
                Third Class, assisting with administrative duties aboard the ship. 
            </p>
            <p>
                During his time in the Navy, Juan's first daughter Barbara (Barbie) was born on November 8th, 1965. Not long after, 
            ...
            <p>
                ...
                Juan accepted a job working for the City Loan & Finance Company. He began as a collector, eventually moving into 
                the position of Loan Officer. 
            </p>
            <p>
                In 1969, Juan was hired at Valley National Bank, assuming the role of Collector, then Loan Officer, 
                and eventually Manager of the loan department. Juan oversaw ten employees, and was responsible for 
                a loan portfolio of over 12 million dollars. 
            </p>
            <p>
            ...
            <p>
                ...
                workforce, including Juan. Juan looked for work in Douglas, Sierra Vista, and Tucson. Eventually, Juan was
                hired at the Arizona-Mexico Border Health Foundation, where he worked to educate young adults on the 
                consequences of drugs, alcohol, and tobacco. 
            </p>
            <p>
                Juan would chaperone children between the ages of eight and twelve, taking them fishing while educating them on the harmful effects
                of drugs along the way. 
            </p>
            <p>
                In October of 1997, Juan was hired as a manager and loan officer at Southeastern Arizona Federal Credit Union, where
                he remained until his retirement.  
            </p>
            <p>
                Shortly before his retirement from the credit union, Juan formed a band with a group of friends, known
                as "Blind Dawg". 
            </p>
            <img src={bd} alt="Blind Dawg band" class="page-img"/>
            <p style="font-size: .8rem; opacity: 0.5; margin: 10;">
                Blind Dawg together on stage.
             </p>
             <h5>"Actually we weren't too bad, until you started listening to us."</h5>
             <p style="font-size: .8rem; opacity: 0.5; margin: 10;">
                A Texans Life at a Glance 38-5
             </p>
            <h5 style="font-weight: 600">Blind Dawg</h5>
            <ul style="margin: 10px;">
                <li><strong>Juan Peréz:</strong> Lead Guitar & Vocals</li>
                <li><strong>Ernesto Monje:</strong> Rhythm Guitar</li>
                <li><strong>Bobby Monje:</strong> Drums</li>
                <li><strong>Bobby Encinas:</strong> Bass Guitar</li>
            </ul>
            <div style="height: 15px"></div>
            <p>
                Juan was also a member of the Noon Lions Club for over 40 years, helping raise money and 
                assisting those needing eye exams and glasses, as well as donating money to children's programs, sports, 
                scholarships, and other areas of the Douglas community. 
            </p>
            <p>
                Continue reading in the final section, '<strong>Later Years & Family</strong>'. 
            </p>
            <div style="height: 15px"></div>
            <div class="divider"></div>
            <div style="height: 5px"></div>
