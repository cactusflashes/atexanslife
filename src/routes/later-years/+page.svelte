...
<div class="container">
    <div class="body-container">
            ...
            <div style="height: 35px"></div>
             <h5>"We are blessed with our three children, Barbie, Christy, Johnny, their spouses, and the loving grandchildren
                ...
                <p style="font-size: .8rem; opacity: 0.5; margin: 10;">
                 ...
                 <h2 style="margin-bottom: 0">A Poem From Mom & Dad</h2>
                 <h2 style="width: 100%; font-size: 1.5rem">
                    We laughed, we cried, <br>
                    We danced that night <br>
                    Oh what a great time we had! <br>
                    The words that were said <br>
                    Weren't meant to be sad <br>
                    But touched every heart instead.
                 </h2>
                 <h2 style="width: 100%; font-size: 1.5rem">
                    Dear god, you were there, <br>
                    You sat on that chair <br>
                    And sprinkled the room with love. <br>
                    Mom and Dad, all that weren't there <br>
                    Joined in the fun from above. <br>
                 </h2>
                 <h2 style="width: 100%; font-size: 1.5rem">
                    Our family, our friends <br>
                    We looked all around <br>
                    Oh, what a sight to see. <br>
                    The smiles, the tears, the joy and cheers <br>
                    True blessings that came from thee. <br>
                 </h2>
                 <h2 style="width: 100%; font-size: 1.5rem">
                    We thank you lord <br>
                    For that wonderful night <br>
                    And deep in our hearts we could tell <br>
                    That you were there, right by our side <br>
                    Making sure that all went well. <br>
                 </h2>
                 <h2>"Our heart is like a completed puzzle. Each piece is a member of our family."</h2>
            ...
            <div style="height: 5px"></div>
            <p style="font-size: .8rem; opacity: 0.5; margin: 10;">
                Read '<strong>A Texans Life at a Glance</strong>' at the '<strong>Biography</strong>' tab.
            </p>
